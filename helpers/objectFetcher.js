...
function fetchObjects(params) {
    if (!params.cfg) throw new Error('Can\'t fetch objects without a configuration parameter');
    if (!params.cfg.apiVersion) throw new Error('Can\'t fetch objects without an apiVersion');
    if (!params.cfg.object) throw new Error('Can\'t fetch objects without an object type');
    if (!params.snapshot) throw new Error('Can\'t fetch objects without a predefined snapshot');
