...
describe("Create Object module: getMetaModel", () => {
  ...
  it(`Retrieves metadata for Document object`, testMetaData.bind(null, "Document", testData.getMetaModelDocumentReply));
  it(`Retrieves metadata for Account object`, testMetaData.bind(null, "Account", testData.getMetaModelAccountReply));
});
