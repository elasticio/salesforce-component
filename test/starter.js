...
fns.push(function(callback) {
    'use strict';
    require('../lib/actions/case.js').getMetaModel( _.clone(conf), newCallback(callback));
});

fns.push(function(callback) {
    'use strict';
    require('../lib/actions/case.js').process(null, _.clone(conf), newCallback(callback), snapshot);
});

fns.push(function(callback) {
    'use strict';
    require('../lib/entry.js').process(null, _.clone(conf), newCallback(callback), snapshot);
});
