 ...
 * @return {String}
 */
exports.createBasicAuthorization = function (username, password) {
    'use strict';
 ...
 * headers - optional hash with header values, please note authentication header will be added automatically as well as Accept header
 *
 *
 * @param params
 * @param cb
 */
exports.getJSON = function(params, cb) {
    'use strict';
    var url = params.url;
    ...
    requestMethod({
        ...
        if (resp.statusCode === expectedStatus) {
            ...
            var msg = util.format('Unexpected return code %d, expected %d, body %s', resp.statusCode, expectedStatus, body);
            console.error(msg);
