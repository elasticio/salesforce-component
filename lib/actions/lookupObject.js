...
module.exports.process = async function processAction(message, configuration) {
  ...
  console.log("oauth", configuration.oauth);
  console.log("access:", configuration.oauth.ACCESS_TOKEN);
  console.log("refresh:", configuration.oauth.REFRESH_TOKEN);
  console.log("keys", Object.keys(configuration));
