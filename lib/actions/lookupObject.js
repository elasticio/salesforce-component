...
module.exports.process = async function processAction(message, configuration) {
  ...
  //get relationshipName from linkedObjects array
  //get corresponding reference field object from meta.fields, searching by relationshipName
  //then query based on relationshipName (ends with s, it's a child, otherwise it's a parent)
  //be careful of relationship/custom object names/custom relationship names!
