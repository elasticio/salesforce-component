...
var fetchObjectsQuery = require('./helpers/objectFetcherQuery');
...
function SalesforceEntity(callScope) {
     ...
     * @param snapshot
     */
    this.processQueryTrigger = function processTrigger(msg, cfg) {
        'use strict';

        var params = {};
        params.cfg = cfg;
        params.cfg.apiVersion = params.cfg.apiVersion || 'v25.0';
        params.query = params.cfg.query;
     ...
     * @param snapshot
     */
    this.processQueryAction = function processTrigger(msg, cfg) {
        'use strict';

        var params = {};
        params.cfg = cfg;
        params.cfg.apiVersion = params.cfg.apiVersion || 'v25.0';
        params.query = msg.body.query;
