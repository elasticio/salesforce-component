...
var SalesforceEntity = function(callScope) {
    ...
    /**
     * This function refreshes salesforce token with these params: 
     ...
     * @param snapshot
     */
    this.process = function (msg, conf, snapshot) {
        "use strict";
        ...
        tokenPromise(params.cfg).then(function (cfg) {
            ...
            .then(function (params) {
                params.metadata = converter(params.description);
     ...
     * @param next
     */
    this.processAction = function (objectType, msg, conf) {
        'use strict';
...
exports.buildTrigger = function(objectType, exports){
    ...
    exports.process = function (msg, conf, snapshot) {
        var entity = new SalesforceEntity(this);
        // Set fixed object type to the configuration object
        conf.object = objectType;
        // Proceed as usual
        entity.process(msg, conf, snapshot);
    };
